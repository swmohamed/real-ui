...
|---|---|---|
| A. REQUIREMENTS | what the product does, users, business purpose, required content, platform, technical constraints, SEO/a11y obligations | PRESERVE |
...
3. Hunt the subtle ones — they live only in presentation and die
   ...
   content · recent activity · preferences.
