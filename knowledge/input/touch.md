...
- Reach depends on posture, grip, handedness, device/window, keyboard, and
  assistive technology. Test frequent and consequential actions; lower
  placement is a candidate, not a universal primary-action rule.
...
- Acknowledge press promptly without implying completion. Use platform- and
  product-appropriate feedback; latency targets must be measured in context.
...
Candidate vocabulary includes tap, long-press, swipe, pull-to-refresh, drag,
pinch, and double-tap. Use only where product/platform conventions and task
support them; avoid gesture collisions and invented capabilities.
